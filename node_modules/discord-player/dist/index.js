...
var GuildQueuePlayerNode = class {
  ...
  async play(res, options) {
    ...
    try {
      ...
      //only youtube
      //const qt = 'youtubeSong';
      this.queue.debug(`Executing onBeforeCreateStream hook (QueryType: ${qt})...`);

      console.log('Debugger Logging in "discord-player/index.js" - track variable: ' + JSON.stringify(track));
      console.log('Debugger Logging in "discord-player/index.js" - src variable: ' + src);
      console.log('Debugger Logging in "discord-player/index.js" - queryType variable: ' + qt);

      let stream = await this.queue.onBeforeCreateStream?.(track, qt || "arbitrary", this.queue).catch(() => null);

      console.log('Debugger Logging in "discord-player/index.js - stream variable": ' + stream);
      ...
      if (!stream) {
        ...
        console.log('Debugger Logging in "discord-player/index.js - stream (2) variable": ' + stream);
      }
